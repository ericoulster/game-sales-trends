...
vg_year = vg_data.groupby('Year')['Global_Sales'].sum()
...
plt.bar(x= vg_year.index, height = vg_year, color='orange')
# change line colour
plt.xlabel('Year')
plt.ylabel('# of Sales Overall (Millions)')
plt.title('Total Game Sales (Based on year released)')
plt.show()
